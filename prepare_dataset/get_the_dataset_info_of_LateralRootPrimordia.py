...
parser.add_argument('--path', default="/data1/myt/dataset/LateralRootPrimordia_processed_wide_boundary/", type=str,
                        help='')
...
for name in val_names:
    LRP_data_dict["val"][name] = os.path.join(LRP_path, "val")+"/"+name    
