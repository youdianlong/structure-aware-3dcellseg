...
class Cell_Seg_3D_Dataset(Dataset):
    ...
    def get(self, idx, file_format='.npy', crop_size = (64, 64, 64), boundary_importance = 1, need_tensor_output = True, need_transform = True):
        ...
        d, h, w = raw_3d_img.shape
        d_new, h_new, w_new = crop_size
        if self.mode == "train":
            ...
            start_points = (d_start, h_start, w_start)
