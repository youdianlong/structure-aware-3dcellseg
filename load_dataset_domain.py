...
from prepare_dataset.get_the_dataset_info_of_ATAS import ATAS_data_dict
from prepare_dataset.get_the_dataset_info_of_Ovules import Ovules_data_dict
...
if __name__ == '__main__':
    ...
    ATAS_data_dict = {f'Ovules_{i}': path for i, path in enumerate(ATAS_dataset_info['train'])}  # Already in {name: {"raw":...}} format
    ...
    Ovules_data_dict = {f'Ovules_{i}': path for i, path in enumerate(Ovules_dataset_info['train'])}
